...
![Capture dՎcran 2023-10-02 092048](https://github.com/zad-sixstrings/move-it/assets/14813374/96ae3cdc-358a-4314-9766-53444f1efbda)
...
## Who ?
This program will come in handy if you are in the same situation, where you have a lot of unsorted files to sort, move and organize. This program will help you with the first step of moving recovered data from the source folder to whatever destination. E.g : I use it to move all images (with jpg, jpeg, png, cr2 etc. in the file extension field) to a specific directory, and so on.
